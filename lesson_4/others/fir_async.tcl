...
import_files -norecurse [pwd]/hdl/fir_async.v
import_files -norecurse [pwd]/hdl/coef_lp.mem
import_files -norecurse [pwd]/hdl/controller_dds.v

create_bd_cell -type module -reference fir_async fir_async_0
...
# connection
# fir_async
connect_bd_net [get_bd_pins fir_async_0/clk] [get_bd_pins clk_wiz_0/clk_out1]
connect_bd_net [get_bd_pins fir_async_0/rstn] [get_bd_pins clk_wiz_0/locked]
connect_bd_net [get_bd_pins fir_async_0/in_data] [get_bd_pins dds_compiler_0/m_axis_data_tdata]
connect_bd_net [get_bd_pins fir_async_0/in_vld] [get_bd_pins dds_compiler_0/m_axis_data_tvalid]
connect_bd_net [get_bd_pins fir_async_0/out_data] [get_bd_pins system_ila_0/probe0]
connect_bd_net [get_bd_pins fir_async_0/out_vld] [get_bd_pins system_ila_0/probe1]
