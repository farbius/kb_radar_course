...
proc create_root_design { parentCell } {
  ...
  # Create instance: fir_async_0, and set properties
  set block_name fir_async
  set block_cell_name fir_async_0
  if { [catch {set fir_async_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $fir_async_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.MEM_FILE {D:/work/radar_course/lesson_4/vivado/fir_async/fir_async.srcs/sources_1/imports/hdl/coef_lp.mem} \
 ] $fir_async_0
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins controller_dds_0/clk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins fir_async_0/clk] [get_bd_pins system_ila_0/clk] [get_bd_pins vio_0/clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins controller_dds_0/rstn] [get_bd_pins dds_compiler_0/aresetn] [get_bd_pins fir_async_0/rstn]
  connect_bd_net -net controller_dds_0_sync [get_bd_pins controller_dds_0/sync] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net dds_compiler_0_m_axis_data_tdata [get_bd_pins dds_compiler_0/m_axis_data_tdata] [get_bd_pins fir_async_0/in_data]
  connect_bd_net -net dds_compiler_0_m_axis_data_tvalid [get_bd_pins dds_compiler_0/m_axis_data_tvalid] [get_bd_pins fir_async_0/in_vld]
  connect_bd_net -net fir_async_0_out_data [get_bd_pins fir_async_0/out_data] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net fir_async_0_out_vld [get_bd_pins fir_async_0/out_vld] [get_bd_pins system_ila_0/probe1]
