...
module design_1
  ...
  wire [23:0]fir_async_0_out_data;
  wire fir_async_0_out_vld;
  ...
  design_1_fir_async_0_0 fir_async_0
       (.clk(clk_wiz_0_clk_out1),
        .in_data(dds_compiler_0_m_axis_data_tdata),
        .in_vld(dds_compiler_0_m_axis_data_tvalid),
        .out_data(fir_async_0_out_data),
        .out_vld(fir_async_0_out_vld),
        .rstn(clk_wiz_0_locked));
  design_1_system_ila_0_0 system_ila_0
       (.clk(clk_wiz_0_clk_out1),
        .probe0(fir_async_0_out_data),
        .probe1(fir_async_0_out_vld),
