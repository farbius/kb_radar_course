...
connect_bd_intf_net -intf_net Conn2 [get_bd_intf_ports SLOT_2_AXIS] [get_bd_intf_pins g_inst/slot_2_axis]
  ...
  connect_bd_net -net net_slot_1_axi_ar_ctrl [get_bd_pins ila_lib/probe33] [get_bd_pins slot_1_ar/dout]
  ...
  connect_bd_net -net net_slot_1_axi_aw_ctrl [get_bd_pins ila_lib/probe30] [get_bd_pins slot_1_aw/dout]
  connect_bd_net -net net_slot_1_axi_awaddr [get_bd_pins g_inst/m_slot_1_axi_awaddr] [get_bd_pins ila_lib/probe22]
  connect_bd_net -net net_slot_1_axi_awlen [get_bd_pins g_inst/m_slot_1_axi_awlen] [get_bd_pins ila_lib/probe23]
  connect_bd_net -net net_slot_1_axi_awready [get_bd_pins g_inst/m_slot_1_axi_awready] [get_bd_pins slot_1_aw/In1]
  connect_bd_net -net net_slot_1_axi_awsize [get_bd_pins g_inst/m_slot_1_axi_awsize] [get_bd_pins ila_lib/probe24]
  connect_bd_net -net net_slot_1_axi_awvalid [get_bd_pins g_inst/m_slot_1_axi_awvalid] [get_bd_pins slot_1_aw/In0]
  connect_bd_net -net net_slot_1_axi_b_cnt [get_bd_pins g_inst/m_slot_1_axi_b_cnt] [get_bd_pins ila_lib/probe25]
  connect_bd_net -net net_slot_1_axi_b_ctrl [get_bd_pins ila_lib/probe32] [get_bd_pins slot_1_b/dout]
  ...
  connect_bd_net -net net_slot_1_axi_r_ctrl [get_bd_pins ila_lib/probe34] [get_bd_pins slot_1_r/dout]
  ...
  connect_bd_net -net net_slot_1_axi_w_ctrl [get_bd_pins ila_lib/probe31] [get_bd_pins slot_1_w/dout]
