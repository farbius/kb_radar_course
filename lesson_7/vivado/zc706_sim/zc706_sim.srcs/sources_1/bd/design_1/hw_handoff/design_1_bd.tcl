...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_PROBE_OUT1_INIT_VAL {0x64} \
  ...
  connect_bd_intf_net -intf_net iq_modulator_0_m_axis [get_bd_intf_ports m_axis_0] [get_bd_intf_pins iq_modulator_0/m_axis]
  ...
  connect_bd_net -net rst_clk_wiz_0_10M_peripheral_aresetn [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins dds_compiler_1/aresetn] [get_bd_pins mod_subsys_0/rstn] [get_bd_pins ref_phase_0/rstn] [get_bd_pins rst_clk_wiz_0_10M/peripheral_aresetn]
