...
connect_bd_intf_net -intf_net fir_axis_0_M00_AXIS [get_bd_intf_pins fir_axis_0/M00_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
connect_bd_intf_net -intf_net fir_axis_1_M00_AXIS [get_bd_intf_pins fir_axis_1/M00_AXIS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
connect_bd_intf_net -intf_net fir_axis_2_M00_AXIS [get_bd_intf_pins fir_axis_2/M00_AXIS] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins controller_dds_0/clk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins fir_axis_0/s00_axis_aclk] [get_bd_pins fir_axis_1/s00_axis_aclk] [get_bd_pins fir_axis_2/s00_axis_aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins vio_0/clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins controller_dds_0/rstn] [get_bd_pins dds_compiler_0/aresetn] [get_bd_pins fir_axis_0/s00_axis_aresetn] [get_bd_pins fir_axis_1/s00_axis_aresetn] [get_bd_pins fir_axis_2/s00_axis_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net controller_dds_0_sync [get_bd_pins controller_dds_0/sync] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net dds_compiler_0_m_axis_data_tdata [get_bd_pins dds_compiler_0/m_axis_data_tdata] [get_bd_pins fir_axis_0/s00_axis_tdata] [get_bd_pins fir_axis_1/s00_axis_tdata] [get_bd_pins fir_axis_2/s00_axis_tdata]
  connect_bd_net -net dds_compiler_0_m_axis_data_tvalid [get_bd_pins dds_compiler_0/m_axis_data_tvalid] [get_bd_pins fir_axis_0/s00_axis_tvalid] [get_bd_pins fir_axis_1/s00_axis_tvalid] [get_bd_pins fir_axis_2/s00_axis_tvalid]
