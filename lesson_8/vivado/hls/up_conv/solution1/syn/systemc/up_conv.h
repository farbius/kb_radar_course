...
struct up_conv : public sc_module {
    ...
    sc_signal< sc_logic > up_conv_entry14_U0_ap_start;
    sc_signal< sc_logic > up_conv_entry14_U0_start_full_n;
    sc_signal< sc_logic > up_conv_entry14_U0_ap_done;
    sc_signal< sc_logic > up_conv_entry14_U0_ap_continue;
    sc_signal< sc_logic > up_conv_entry14_U0_ap_idle;
    sc_signal< sc_logic > up_conv_entry14_U0_ap_ready;
    sc_signal< sc_logic > up_conv_entry14_U0_start_out;
    sc_signal< sc_logic > up_conv_entry14_U0_start_write;
    sc_signal< sc_lv<32> > up_conv_entry14_U0_x_i_out_din;
    sc_signal< sc_logic > up_conv_entry14_U0_x_i_out_write;
    sc_signal< sc_lv<32> > up_conv_entry14_U0_x_q_out_din;
    sc_signal< sc_logic > up_conv_entry14_U0_x_q_out_write;
    sc_signal< sc_lv<8> > up_conv_entry14_U0_ref_i_V_out_din;
    sc_signal< sc_logic > up_conv_entry14_U0_ref_i_V_out_write;
    sc_signal< sc_lv<8> > up_conv_entry14_U0_ref_q_V_out_din;
    sc_signal< sc_logic > up_conv_entry14_U0_ref_q_V_out_write;
    ...
    sc_signal< sc_lv<32> > fir_filter_a_U0_ap_return;
    sc_signal< sc_logic > ap_channel_done_i_tmp;
    sc_signal< sc_logic > i_tmp_full_n;
    ...
    sc_signal< sc_lv<32> > fir_filter_b_U0_ap_return;
    sc_signal< sc_logic > ap_channel_done_q_tmp;
    sc_signal< sc_logic > q_tmp_full_n;
    ...
    sc_signal< sc_lv<32> > i_tmp_dout;
    sc_signal< sc_logic > i_tmp_empty_n;
    sc_signal< sc_lv<32> > q_tmp_dout;
    sc_signal< sc_logic > q_tmp_empty_n;
    ...
    void thread_ap_channel_done_i_tmp();
    void thread_ap_channel_done_q_tmp();
    ...
    void thread_up_conv_entry14_U0_ap_continue();
    void thread_up_conv_entry14_U0_ap_start();
    void thread_up_conv_entry14_U0_start_full_n();
    void thread_y();
