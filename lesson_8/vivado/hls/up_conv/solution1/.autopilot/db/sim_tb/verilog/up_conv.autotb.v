...
`define AUTOTB_TVIN_x_i  "./c.up_conv.autotvin_x_i.dat"
`define AUTOTB_TVIN_x_q  "./c.up_conv.autotvin_x_q.dat"
`define AUTOTB_TVIN_ref_i_V  "./c.up_conv.autotvin_ref_i_V.dat"
`define AUTOTB_TVIN_ref_q_V  "./c.up_conv.autotvin_ref_q_V.dat"
`define AUTOTB_TVIN_x_i_out_wrapc  "./rtl.up_conv.autotvin_x_i.dat"
`define AUTOTB_TVIN_x_q_out_wrapc  "./rtl.up_conv.autotvin_x_q.dat"
`define AUTOTB_TVIN_ref_i_V_out_wrapc  "./rtl.up_conv.autotvin_ref_i_V.dat"
`define AUTOTB_TVIN_ref_q_V_out_wrapc  "./rtl.up_conv.autotvin_ref_q_V.dat"
`define AUTOTB_TVOUT_y  "./c.up_conv.autotvout_y.dat"
`define AUTOTB_TVOUT_y_out_wrapc  "./impl_rtl.up_conv.autotvout_y.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.up_conv.autotvout_y.dat", "r");
    fp2 = $fopen("./impl_rtl.up_conv.autotvout_y.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.up_conv.autotvout_y.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.up_conv.autotvout_y.dat\"!");
    else begin
        $display("Comparing rtl.up_conv.autotvout_y.dat with impl_rtl.up_conv.autotvout_y.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
