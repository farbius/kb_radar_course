...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "up_conv.autotvin.dat"
	set constFileTvOut       "up_conv.autotvout.dat"
	set constFileHdlTvIn     "up_conv.autohdltvin.dat"
	set constFileHdlTvOut    "up_conv.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
