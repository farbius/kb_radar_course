...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "d_conv.autotvin.dat"
	set constFileTvOut       "d_conv.autotvout.dat"
	set constFileHdlTvIn     "d_conv.autohdltvin.dat"
	set constFileHdlTvOut    "d_conv.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
