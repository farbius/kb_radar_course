...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.d_conv.autotvin_x_V.dat"
         "c.d_conv.autotvin_ref_i_V.dat"
         "c.d_conv.autotvin_ref_q_V.dat"
         "c.d_conv.autotvout_y_i_V.dat"
         "c.d_conv.autotvout_y_q_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.d_conv.autotvout_y_i_V.dat"
         "rtl.d_conv.autotvout_y_q_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
