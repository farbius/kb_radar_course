...
// ==============================================================
#ifndef __d_conv_mac_muladddEe__HH__
#define __d_conv_mac_muladddEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(d_conv_mac_muladddEe) {
    ...
    SC_CTOR(d_conv_mac_muladddEe):  simcore_mac_0_U ("simcore_mac_0_U") {
