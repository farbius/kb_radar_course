...
// ==============================================================
#ifndef __d_conv_mul_mul_16cud__HH__
#define __d_conv_mul_mul_16cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(d_conv_mul_mul_16cud) {
    ...
    SC_CTOR(d_conv_mul_mul_16cud):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
