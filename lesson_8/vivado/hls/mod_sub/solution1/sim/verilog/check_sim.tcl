...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.mod_sub.autotvin_ix_V.dat"
         "c.mod_sub.autotvin_qx_V.dat"
         "c.mod_sub.autotvin_i_mod_V.dat"
         "c.mod_sub.autotvin_q_mod_V.dat"
         "c.mod_sub.autotvin_period_V.dat"
         "c.mod_sub.autotvin_mux_V.dat"
         "c.mod_sub.autotvout_iy_V.dat"
         "c.mod_sub.autotvout_qy_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.mod_sub.autotvout_iy_V.dat"
         "rtl.mod_sub.autotvout_qy_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
