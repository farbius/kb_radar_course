...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mod_sub.autotvin.dat"
	set constFileTvOut       "mod_sub.autotvout.dat"
	set constFileHdlTvIn     "mod_sub.autohdltvin.dat"
	set constFileHdlTvOut    "mod_sub.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
