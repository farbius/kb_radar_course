...
// ==============================================================
#ifndef __fir_hls_mac_muladjbC__HH__
#define __fir_hls_mac_muladjbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_hls_mac_muladjbC) {
    ...
    SC_CTOR(fir_hls_mac_muladjbC):  simcore_mac_5_U ("simcore_mac_5_U") {
