...
// ==============================================================
#ifndef __fir_hls_mul_mul_8dEe__HH__
#define __fir_hls_mul_mul_8dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_hls_mul_mul_8dEe) {
    ...
    SC_CTOR(fir_hls_mul_mul_8dEe):  ACMP_smul_su_U ("ACMP_smul_su_U") {
