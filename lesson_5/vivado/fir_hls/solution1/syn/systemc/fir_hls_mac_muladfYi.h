...
// ==============================================================
#ifndef __fir_hls_mac_muladfYi__HH__
#define __fir_hls_mac_muladfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_hls_mac_muladfYi) {
    ...
    SC_CTOR(fir_hls_mac_muladfYi):  simcore_mac_1_U ("simcore_mac_1_U") {
