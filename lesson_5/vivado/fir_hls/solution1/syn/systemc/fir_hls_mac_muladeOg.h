...
// ==============================================================
#ifndef __fir_hls_mac_muladeOg__HH__
#define __fir_hls_mac_muladeOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_hls_mac_muladeOg) {
    ...
    SC_CTOR(fir_hls_mac_muladeOg):  simcore_mac_0_U ("simcore_mac_0_U") {
