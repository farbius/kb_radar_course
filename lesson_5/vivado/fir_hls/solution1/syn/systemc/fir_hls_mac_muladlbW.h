...
// ==============================================================
#ifndef __fir_hls_mac_muladlbW__HH__
#define __fir_hls_mac_muladlbW__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_hls_mac_muladlbW) {
    ...
    SC_CTOR(fir_hls_mac_muladlbW):  simcore_mac_7_U ("simcore_mac_7_U") {
