...
// ==============================================================
#ifndef __fir_hls_mac_muladkbM__HH__
#define __fir_hls_mac_muladkbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_hls_mac_muladkbM) {
    ...
    SC_CTOR(fir_hls_mac_muladkbM):  simcore_mac_6_U ("simcore_mac_6_U") {
