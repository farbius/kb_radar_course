...
// ==============================================================
#ifndef __fir_hls_mac_muladibs__HH__
#define __fir_hls_mac_muladibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_hls_mac_muladibs) {
    ...
    SC_CTOR(fir_hls_mac_muladibs):  simcore_mac_4_U ("simcore_mac_4_U") {
