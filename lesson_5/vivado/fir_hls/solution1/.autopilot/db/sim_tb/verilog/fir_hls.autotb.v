...
`define AUTOTB_TVIN_x_V  "./c.fir_hls.autotvin_x_V.dat"
`define AUTOTB_TVIN_y  "./c.fir_hls.autotvin_y.dat"
`define AUTOTB_TVIN_x_V_out_wrapc  "./rtl.fir_hls.autotvin_x_V.dat"
`define AUTOTB_TVIN_y_out_wrapc  "./rtl.fir_hls.autotvin_y.dat"
`define AUTOTB_TVOUT_y  "./c.fir_hls.autotvout_y.dat"
`define AUTOTB_TVOUT_y_out_wrapc  "./impl_rtl.fir_hls.autotvout_y.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.fir_hls.autotvout_y.dat", "r");
    fp2 = $fopen("./impl_rtl.fir_hls.autotvout_y.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.fir_hls.autotvout_y.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.fir_hls.autotvout_y.dat\"!");
    else begin
        $display("Comparing rtl.fir_hls.autotvout_y.dat with impl_rtl.fir_hls.autotvout_y.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
begin
    ...
    `define STREAM_SIZE_IN_x_V "./stream_size_in_x_V.dat"
    ...
    `define STREAM_SIZE_OUT_y "./stream_size_out_y.dat"
