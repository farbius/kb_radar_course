...
proc create_root_design { parentCell } {
  ...
  set SLOT_3_BRAM [ create_bd_intf_port -mode Monitor -vlnv xilinx.com:interface:bram_rtl:1.0 SLOT_3_BRAM ]
...
connect_bd_intf_net -intf_net Conn2 [get_bd_intf_ports SLOT_2_AXIS] [get_bd_intf_pins g_inst/slot_2_axis]
  ...
  connect_bd_net -net SLOT_3_BRAM_addr_1 [get_bd_ports SLOT_3_BRAM_addr] [get_bd_pins ila_lib/probe41]
  connect_bd_net -net SLOT_3_BRAM_din_1 [get_bd_ports SLOT_3_BRAM_din] [get_bd_pins ila_lib/probe42]
  connect_bd_net -net SLOT_3_BRAM_dout_1 [get_bd_ports SLOT_3_BRAM_dout] [get_bd_pins ila_lib/probe43]
  connect_bd_net -net SLOT_3_BRAM_en_1 [get_bd_ports SLOT_3_BRAM_en] [get_bd_pins ila_lib/probe44]
  connect_bd_net -net SLOT_3_BRAM_rst_1 [get_bd_ports SLOT_3_BRAM_rst] [get_bd_pins ila_lib/probe45]
  connect_bd_net -net SLOT_3_BRAM_we_1 [get_bd_ports SLOT_3_BRAM_we] [get_bd_pins ila_lib/probe46]
  connect_bd_net -net SLOT_4_BRAM_addr_1 [get_bd_ports SLOT_4_BRAM_addr] [get_bd_pins ila_lib/probe47]
  connect_bd_net -net SLOT_4_BRAM_din_1 [get_bd_ports SLOT_4_BRAM_din] [get_bd_pins ila_lib/probe48]
  connect_bd_net -net SLOT_4_BRAM_dout_1 [get_bd_ports SLOT_4_BRAM_dout] [get_bd_pins ila_lib/probe49]
  connect_bd_net -net SLOT_4_BRAM_en_1 [get_bd_ports SLOT_4_BRAM_en] [get_bd_pins ila_lib/probe50]
  connect_bd_net -net SLOT_4_BRAM_rst_1 [get_bd_ports SLOT_4_BRAM_rst] [get_bd_pins ila_lib/probe51]
  connect_bd_net -net SLOT_4_BRAM_we_1 [get_bd_ports SLOT_4_BRAM_we] [get_bd_pins ila_lib/probe52]
  ...
  connect_bd_net -net net_slot_1_axi_r_cnt [get_bd_pins g_inst/m_slot_1_axi_r_cnt] [get_bd_pins ila_lib/probe27]
  connect_bd_net -net net_slot_1_axi_r_ctrl [get_bd_pins ila_lib/probe35] [get_bd_pins slot_1_r/dout]
  connect_bd_net -net net_slot_1_axi_rdata [get_bd_pins g_inst/m_slot_1_axi_rdata] [get_bd_pins ila_lib/probe28]
  ...
  connect_bd_net -net net_slot_1_axi_rresp [get_bd_pins g_inst/m_slot_1_axi_rresp] [get_bd_pins ila_lib/probe29]
  ...
  connect_bd_net -net net_slot_2_axis_tdata [get_bd_pins g_inst/m_slot_2_axis_tdata] [get_bd_pins ila_lib/probe36]
  connect_bd_net -net net_slot_2_axis_tkeep [get_bd_pins g_inst/m_slot_2_axis_tkeep] [get_bd_pins ila_lib/probe37]
