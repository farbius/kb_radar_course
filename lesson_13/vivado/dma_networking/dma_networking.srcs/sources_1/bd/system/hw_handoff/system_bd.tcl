...
proc create_root_design { parentCell } {
  ...
  # Create instance: s_axi_generator_0, and set properties
  set block_name s_axi_generator
  set block_cell_name s_axi_generator_0
  if { [catch {set s_axi_generator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $s_axi_generator_0 eq "" } {
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_dwidth_converter_0_M_AXIS] [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins s_axi_generator_0/S_AXI]
  connect_bd_intf_net -intf_net s_axi_generator_0_M_AXIS [get_bd_intf_pins axis_dwidth_converter_0/S_AXIS] [get_bd_intf_pins s_axi_generator_0/M_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets s_axi_generator_0_M_AXIS] [get_bd_intf_pins s_axi_generator_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]

  # Create port connections
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net axis_data_fifo_0_almost_full [get_bd_pins axis_data_fifo_0/almost_full] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins s_axi_generator_0/S_AXI_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_250M/slowest_sync_clk] [get_bd_pins s_axi_generator_0/M_AXIS_ACLK] [get_bd_pins system_ila_0/clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins s_axi_generator_0/S_AXI_ARESETN]
  connect_bd_net -net rst_ps7_0_250M_interconnect_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps7_0_250M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_250M_peripheral_aresetn [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins rst_ps7_0_250M/peripheral_aresetn] [get_bd_pins s_axi_generator_0/M_AXIS_ARESETN] [get_bd_pins system_ila_0/resetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs s_axi_generator_0/S_AXI/reg0] SEG_s_axi_generator_0_reg0
