...
proc create_root_design { parentCell } {
  ...
  if { [catch {set iq_modulator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.MEM_FILE {D:/work/radar_course/lesson_6/vivado/iq_mod_zc706/iq_mod_zc706.srcs/sources_1/imports/hdl/coef_lp.mem} \
 ] $iq_modulator_0
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins iq_modulator_0/s_axis]
  ...
  connect_bd_intf_net -intf_net dds_compiler_0_M_AXIS_DATA [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins dds_compiler_0/M_AXIS_DATA]
  connect_bd_intf_net -intf_net dds_compiler_1_M_AXIS_DATA [get_bd_intf_pins dds_compiler_1/M_AXIS_DATA] [get_bd_intf_pins iq_modulator_0/s_axis_ref]
connect_bd_intf_net -intf_net iq_modulator_0_m_axis [get_bd_intf_pins iq_modulator_0/m_axis] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins controller_dds_0/clk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins rst_clk_wiz_0_25M/slowest_sync_clk] [get_bd_pins vio_0/clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins dds_compiler_1/aclk] [get_bd_pins iq_modulator_0/clk] [get_bd_pins rst_clk_wiz_0_250M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_250M/dcm_locked] [get_bd_pins rst_clk_wiz_0_25M/dcm_locked]
  connect_bd_net -net controller_dds_0_sync [get_bd_pins controller_dds_0/sync] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net iq_modulator_0_filt_tdata_dbg [get_bd_pins iq_modulator_0/filt_tdata_dbg] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net iq_modulator_0_filt_tvalid_dbg [get_bd_pins iq_modulator_0/filt_tvalid_dbg] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins rst_clk_wiz_0_250M/ext_reset_in] [get_bd_pins rst_clk_wiz_0_25M/ext_reset_in]
  connect_bd_net -net rst_clk_wiz_0_250M_peripheral_aresetn [get_bd_pins dds_compiler_1/aresetn] [get_bd_pins iq_modulator_0/rstn] [get_bd_pins rst_clk_wiz_0_250M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net rst_clk_wiz_0_25M_peripheral_aresetn [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins controller_dds_0/rstn] [get_bd_pins dds_compiler_0/aresetn] [get_bd_pins rst_clk_wiz_0_25M/peripheral_aresetn]
